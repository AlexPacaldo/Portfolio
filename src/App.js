          ...
          <main>
              ...
              <div className='Caru' data-aos = 'fade-up'>
                <svg className='svgTop' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                  <g className="svgWave">
                    <path fill="#000000ff" fill-opacity="1" d="M0,160C60,110 120,210 180,160C240,110 300,210 360,160C420,110 480,210 540,160C600,110 660,210 720,160C780,110 840,210 900,160C960,110 1020,210 1080,160C1140,110 1200,210 1260,160C1320,110 1380,210 1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
                    <path fill="#000000ff" fill-opacity="1" transform="translate(1440,0)" d="M0,160C60,110 120,210 180,160C240,110 300,210 360,160C420,110 480,210 540,160C600,110 660,210 720,160C780,110 840,210 900,160C960,110 1020,210 1080,160C1140,110 1200,210 1260,160C1320,110 1380,210 1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
                  </g>
                </svg>
                ...
                <svg className='svgBot' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                  <g className="svgWave">
                    <path fill="#000000ff" fill-opacity="1" d="M0,160C60,110 120,210 180,160C240,110 300,210 360,160C420,110 480,210 540,160C600,110 660,210 720,160C780,110 840,210 900,160C960,110 1020,210 1080,160C1140,110 1200,210 1260,160C1320,110 1380,210 1440,160L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path>
                    <path fill="#000000ff" fill-opacity="1" transform="translate(1440,0)" d="M0,160C60,110 120,210 180,160C240,110 300,210 360,160C420,110 480,210 540,160C600,110 660,210 720,160C780,110 840,210 900,160C960,110 1020,210 1080,160C1140,110 1200,210 1260,160C1320,110 1380,210 1440,160L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path>
                  </g>
                </svg>
              </div>
